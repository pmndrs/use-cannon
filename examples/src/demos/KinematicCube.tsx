...
import { Physics, useBox, useInfinitePlane, useSphere } from '@react-three/cannon'
...
type OurPlaneProps = Pick<MeshPhongMaterialProps, 'color'> & Pick<InfinitePlaneProps, 'position' | 'rotation'>
